...
TOKENS.TOKEN_EOF = Token(id="TOKEN_EOF", number=0, string="end of file")
TOKENS.JUNK = Token(id="JUNK", string="junk")

TOKENS.NEWLINE = Token(id="NEWLINE", string="newline")
TOKENS.COLON = Token(id="COLON", string="colon")
TOKENS.SEMICOLON = Token(id="SEMICOLON", string="semicolon")
TOKENS.COMMA = Token(id="COMMA", string="comma")
TOKENS.DOT = Token(id="DOT", string=".")

TOKENS.EQ = Token(id="EQ", string="==")
TOKENS.NEQ = Token(id="NEQ", string="!=")
TOKENS.LT = Token(id="LT", string="<")
TOKENS.GT = Token(id="GT", string=">")
TOKENS.GTE = Token(id="GTE", string=">=")
TOKENS.LTE = Token(id="LTE", string="<=")
TOKENS.LSHIFT = Token(id="LSHIFT", string="<<")
TOKENS.RSHIFT = Token(id="RSHIFT", string=">>")
TOKENS.AMPERSAND = Token(id="AMPERSAND", string="&")
TOKENS.CARET = Token(id="CARET", string="^")
TOKENS.NOT = Token(id="NOT", string="!")
TOKENS.SLASH = Token(id="SLASH", string="/")
TOKENS.ASTERISK = Token(id="ASTERISK", string="*")
TOKENS.DASH = Token(id="DASH", string="-")
TOKENS.AT = Token(id="AT", string="@")
TOKENS.VMAP = Token(id="VMAP", string="vmap")

TOKENS.PLUS = Token(id="PLUS", string="+")

TOKENS.INCLUDE = Token(id="INCLUDE", string="include")
TOKENS.DEFINE = Token(id="DEFINE", string="define")
TOKENS.REDEFINE = Token(id="REDEFINE", string="redefine")
TOKENS.UNDEFINE = Token(id="UNDEFINE", string="undefine")

TOKENS.FIB = Token(id="FIB", string="fib")

TOKENS.SOCKET = Token(id="SOCKET", string="socket")
TOKENS.TRANSPARENT = Token(id="TRANSPARENT", string="transparent")
TOKENS.WILDCARD = Token(id="WILDCARD", string="wildcard")

TOKENS.TPROXY = Token(id="TPROXY", string="tproxy")

TOKENS.OSF = Token(id="OSF", string="osf")

TOKENS.SYNPROXY = Token(id="SYNPROXY", string="synproxy")
TOKENS.MSS = Token(id="MSS", string="mss")
TOKENS.WSCALE = Token(id="WSCALE", string="wscale")

TOKENS.TYPEOF = Token(id="TYPEOF", string="typeof")

TOKENS.HOOK = Token(id="HOOK", string="hook")
TOKENS.DEVICE = Token(id="DEVICE", string="device")
TOKENS.DEVICES = Token(id="DEVICES", string="devices")
TOKENS.TABLE = Token(id="TABLE", string="table")
TOKENS.TABLES = Token(id="TABLES", string="tables")
TOKENS.CHAIN = Token(id="CHAIN", string="chain")
TOKENS.CHAINS = Token(id="CHAINS", string="chains")
TOKENS.RULE = Token(id="RULE", string="rule")
TOKENS.RULES = Token(id="RULES", string="rules")
TOKENS.SETS = Token(id="SETS", string="sets")
TOKENS.SET = Token(id="SET", string="set")
TOKENS.ELEMENT = Token(id="ELEMENT", string="element")
TOKENS.MAP = Token(id="MAP", string="map")
TOKENS.MAPS = Token(id="MAPS", string="maps")
TOKENS.FLOWTABLE = Token(id="FLOWTABLE", string="flowtable")
TOKENS.HANDLE = Token(id="HANDLE", string="handle")
TOKENS.RULESET = Token(id="RULESET", string="ruleset")
TOKENS.TRACE = Token(id="TRACE", string="trace")

TOKENS.INET = Token(id="INET", string="inet")
TOKENS.NETDEV = Token(id="NETDEV", string="netdev")

TOKENS.ADD = Token(id="ADD", string="add")
TOKENS.UPDATE = Token(id="UPDATE", string="update")
TOKENS.REPLACE = Token(id="REPLACE", string="replace")
TOKENS.CREATE = Token(id="CREATE", string="create")
TOKENS.INSERT = Token(id="INSERT", string="insert")
TOKENS.DELETE = Token(id="DELETE", string="delete")
TOKENS.GET = Token(id="GET", string="get")
TOKENS.LIST = Token(id="LIST", string="list")
TOKENS.RESET = Token(id="RESET", string="reset")
TOKENS.FLUSH = Token(id="FLUSH", string="flush")
TOKENS.RENAME = Token(id="RENAME", string="rename")
TOKENS.DESCRIBE = Token(id="DESCRIBE", string="describe")
TOKENS.IMPORT = Token(id="IMPORT", string="import")
TOKENS.EXPORT = Token(id="EXPORT", string="export")
TOKENS.MONITOR = Token(id="MONITOR", string="monitor")

TOKENS.ALL = Token(id="ALL", string="all")

TOKENS.ACCEPT = Token(id="ACCEPT", string="accept")
TOKENS.DROP = Token(id="DROP", string="drop")
TOKENS.CONTINUE = Token(id="CONTINUE", string="continue")
TOKENS.JUMP = Token(id="JUMP", string="jump")
TOKENS.GOTO = Token(id="GOTO", string="goto")
TOKENS.RETURN = Token(id="RETURN", string="return")
TOKENS.TO = Token(id="TO", string="to")

TOKENS.CONSTANT = Token(id="CONSTANT", string="constant")
TOKENS.INTERVAL = Token(id="INTERVAL", string="interval")
TOKENS.DYNAMIC = Token(id="DYNAMIC", string="dynamic")
TOKENS.AUTOMERGE = Token(id="AUTOMERGE", string="auto-merge")
TOKENS.TIMEOUT = Token(id="TIMEOUT", string="timeout")
TOKENS.GC_INTERVAL = Token(id="GC_INTERVAL", string="gc-interval")
TOKENS.ELEMENTS = Token(id="ELEMENTS", string="elements")
TOKENS.EXPIRES = Token(id="EXPIRES", string="expires")

TOKENS.POLICY = Token(id="POLICY", string="policy")
TOKENS.MEMORY = Token(id="MEMORY", string="memory")
TOKENS.PERFORMANCE = Token(id="PERFORMANCE", string="performance")
TOKENS.SIZE = Token(id="SIZE", string="size")

TOKENS.FLOW = Token(id="FLOW", string="flow")
TOKENS.OFFLOAD = Token(id="OFFLOAD", string="offload")
TOKENS.METER = Token(id="METER", string="meter")
TOKENS.METERS = Token(id="METERS", string="meters")

TOKENS.FLOWTABLES = Token(id="FLOWTABLES", string="flowtables")

TOKENS.NUM = Token(tag="<val>", id="NUM", string="number")
TOKENS.STRING = Token(tag="<string>", id="STRING", string="string")
TOKENS.QUOTED_STRING = Token(tag="<string>", id="QUOTED_STRING", string="quoted string")
TOKENS.ASTERISK_STRING = Token(
    tag="<string>", id="ASTERISK_STRING", string="string with a trailing asterisk"
)
"""
%destructor { xfree($$); }	STRING QUOTED_STRING ASTERISK_STRING
"""

TOKENS.LL_HDR = Token(id="LL_HDR", string="ll")
TOKENS.NETWORK_HDR = Token(id="NETWORK_HDR", string="nh")
TOKENS.TRANSPORT_HDR = Token(id="TRANSPORT_HDR", string="th")

TOKENS.BRIDGE = Token(id="BRIDGE", string="bridge")

TOKENS.ETHER = Token(id="ETHER", string="ether")
TOKENS.SADDR = Token(id="SADDR", string="saddr")
TOKENS.DADDR = Token(id="DADDR", string="daddr")
TOKENS.TYPE = Token(id="TYPE", string="type")

TOKENS.VLAN = Token(id="VLAN", string="vlan")
TOKENS.ID = Token(id="ID", string="id")
TOKENS.CFI = Token(id="CFI", string="cfi")
TOKENS.PCP = Token(id="PCP", string="pcp")

TOKENS.ARP = Token(id="ARP", string="arp")
TOKENS.HTYPE = Token(id="HTYPE", string="htype")
TOKENS.PTYPE = Token(id="PTYPE", string="ptype")
TOKENS.HLEN = Token(id="HLEN", string="hlen")
TOKENS.PLEN = Token(id="PLEN", string="plen")
TOKENS.OPERATION = Token(id="OPERATION", string="operation")

TOKENS.IP = Token(id="IP", string="ip")
TOKENS.HDRVERSION = Token(id="HDRVERSION", string="version")
TOKENS.HDRLENGTH = Token(id="HDRLENGTH", string="hdrlength")
TOKENS.DSCP = Token(id="DSCP", string="dscp")
TOKENS.ECN = Token(id="ECN", string="ecn")
TOKENS.LENGTH = Token(id="LENGTH", string="length")
TOKENS.FRAG_OFF = Token(id="FRAG_OFF", string="frag-off")
TOKENS.TTL = Token(id="TTL", string="ttl")
TOKENS.PROTOCOL = Token(id="PROTOCOL", string="protocol")
TOKENS.CHECKSUM = Token(id="CHECKSUM", string="checksum")

TOKENS.PTR = Token(id="PTR", string="ptr")
TOKENS.VALUE = Token(id="VALUE", string="value")

TOKENS.LSRR = Token(id="LSRR", string="lsrr")
TOKENS.RR = Token(id="RR", string="rr")
TOKENS.SSRR = Token(id="SSRR", string="ssrr")
TOKENS.RA = Token(id="RA", string="ra")

TOKENS.ICMP = Token(id="ICMP", string="icmp")
TOKENS.CODE = Token(id="CODE", string="code")
TOKENS.SEQUENCE = Token(id="SEQUENCE", string="seq")
TOKENS.GATEWAY = Token(id="GATEWAY", string="gateway")
TOKENS.MTU = Token(id="MTU", string="mtu")

TOKENS.IGMP = Token(id="IGMP", string="igmp")
TOKENS.MRT = Token(id="MRT", string="mrt")

TOKENS.OPTIONS = Token(id="OPTIONS", string="options")

TOKENS.IP6 = Token(id="IP6", string="ip6")
TOKENS.PRIORITY = Token(id="PRIORITY", string="priority")
TOKENS.FLOWLABEL = Token(id="FLOWLABEL", string="flowlabel")
TOKENS.NEXTHDR = Token(id="NEXTHDR", string="nexthdr")
TOKENS.HOPLIMIT = Token(id="HOPLIMIT", string="hoplimit")

TOKENS.ICMP6 = Token(id="ICMP6", string="icmpv6")
TOKENS.PPTR = Token(id="PPTR", string="param-problem")
TOKENS.MAXDELAY = Token(id="MAXDELAY", string="max-delay")

TOKENS.AH = Token(id="AH", string="ah")
TOKENS.RESERVED = Token(id="RESERVED", string="reserved")
TOKENS.SPI = Token(id="SPI", string="spi")

TOKENS.ESP = Token(id="ESP", string="esp")

TOKENS.COMP = Token(id="COMP", string="comp")
TOKENS.FLAGS = Token(id="FLAGS", string="flags")
TOKENS.CPI = Token(id="CPI", string="cpi")

TOKENS.PORT = Token(id="PORT", string="port")
TOKENS.UDP = Token(id="UDP", string="udp")
TOKENS.SPORT = Token(id="SPORT", string="sport")
TOKENS.DPORT = Token(id="DPORT", string="dport")
TOKENS.UDPLITE = Token(id="UDPLITE", string="udplite")
TOKENS.CSUMCOV = Token(id="CSUMCOV", string="csumcov")

TOKENS.TCP = Token(id="TCP", string="tcp")
TOKENS.ACKSEQ = Token(id="ACKSEQ", string="ackseq")
TOKENS.DOFF = Token(id="DOFF", string="doff")
TOKENS.WINDOW = Token(id="WINDOW", string="window")
TOKENS.URGPTR = Token(id="URGPTR", string="urgptr")
TOKENS.OPTION = Token(id="OPTION", string="option")
TOKENS.ECHO = Token(id="ECHO", string="echo")
TOKENS.EOL = Token(id="EOL", string="eol")
TOKENS.NOP = Token(id="NOP", string="nop")
TOKENS.SACK = Token(id="SACK", string="sack")
TOKENS.SACK0 = Token(id="SACK0", string="sack0")
TOKENS.SACK1 = Token(id="SACK1", string="sack1")
TOKENS.SACK2 = Token(id="SACK2", string="sack2")
TOKENS.SACK3 = Token(id="SACK3", string="sack3")
TOKENS.SACK_PERM = Token(id="SACK_PERM", string="sack-permitted")
TOKENS.TIMESTAMP = Token(id="TIMESTAMP", string="timestamp")
TOKENS.KIND = Token(id="KIND", string="kind")
TOKENS.COUNT = Token(id="COUNT", string="count")
TOKENS.LEFT = Token(id="LEFT", string="left")
TOKENS.RIGHT = Token(id="RIGHT", string="right")
TOKENS.TSVAL = Token(id="TSVAL", string="tsval")
TOKENS.TSECR = Token(id="TSECR", string="tsecr")

TOKENS.DCCP = Token(id="DCCP", string="dccp")

TOKENS.SCTP = Token(id="SCTP", string="sctp")
TOKENS.VTAG = Token(id="VTAG", string="vtag")

TOKENS.RT = Token(id="RT", string="rt")
TOKENS.RT0 = Token(id="RT0", string="rt0")
TOKENS.RT2 = Token(id="RT2", string="rt2")
TOKENS.RT4 = Token(id="RT4", string="srh")
TOKENS.SEG_LEFT = Token(id="SEG_LEFT", string="seg-left")
TOKENS.ADDR = Token(id="ADDR", string="addr")
TOKENS.LAST_ENT = Token(id="LAST_ENT", string="last-entry")
TOKENS.TAG = Token(id="TAG", string="tag")
TOKENS.SID = Token(id="SID", string="sid")

TOKENS.HBH = Token(id="HBH", string="hbh")

TOKENS.FRAG = Token(id="FRAG", string="frag")
TOKENS.RESERVED2 = Token(id="RESERVED2", string="reserved2")
TOKENS.MORE_FRAGMENTS = Token(id="MORE_FRAGMENTS", string="more-fragments")

TOKENS.DST = Token(id="DST", string="dst")

TOKENS.MH = Token(id="MH", string="mh")

TOKENS.META = Token(id="META", string="meta")
TOKENS.MARK = Token(id="MARK", string="mark")
TOKENS.IIF = Token(id="IIF", string="iif")
TOKENS.IIFNAME = Token(id="IIFNAME", string="iifname")
TOKENS.IIFTYPE = Token(id="IIFTYPE", string="iiftype")
TOKENS.OIF = Token(id="OIF", string="oif")
TOKENS.OIFNAME = Token(id="OIFNAME", string="oifname")
TOKENS.OIFTYPE = Token(id="OIFTYPE", string="oiftype")
TOKENS.SKUID = Token(id="SKUID", string="skuid")
TOKENS.SKGID = Token(id="SKGID", string="skgid")
TOKENS.NFTRACE = Token(id="NFTRACE", string="nftrace")
TOKENS.RTCLASSID = Token(id="RTCLASSID", string="rtclassid")
TOKENS.IBRIPORT = Token(id="IBRIPORT", string="ibriport")
TOKENS.OBRIPORT = Token(id="OBRIPORT", string="obriport")
TOKENS.IBRIDGENAME = Token(id="IBRIDGENAME", string="ibrname")
TOKENS.OBRIDGENAME = Token(id="OBRIDGENAME", string="obrname")
TOKENS.PKTTYPE = Token(id="PKTTYPE", string="pkttype")
TOKENS.CPU = Token(id="CPU", string="cpu")
TOKENS.IIFGROUP = Token(id="IIFGROUP", string="iifgroup")
TOKENS.OIFGROUP = Token(id="OIFGROUP", string="oifgroup")
TOKENS.CGROUP = Token(id="CGROUP", string="cgroup")
TOKENS.TIME = Token(id="TIME", string="time")

TOKENS.CLASSID = Token(id="CLASSID", string="classid")
TOKENS.NEXTHOP = Token(id="NEXTHOP", string="nexthop")

TOKENS.CT = Token(id="CT", string="ct")
TOKENS.L3PROTOCOL = Token(id="L3PROTOCOL", string="l3proto")
TOKENS.PROTO_SRC = Token(id="PROTO_SRC", string="proto-src")
TOKENS.PROTO_DST = Token(id="PROTO_DST", string="proto-dst")
TOKENS.ZONE = Token(id="ZONE", string="zone")
TOKENS.DIRECTION = Token(id="DIRECTION", string="direction")
TOKENS.EVENT = Token(id="EVENT", string="event")
TOKENS.EXPECTATION = Token(id="EXPECTATION", string="expectation")
TOKENS.EXPIRATION = Token(id="EXPIRATION", string="expiration")
TOKENS.HELPER = Token(id="HELPER", string="helper")
TOKENS.LABEL = Token(id="LABEL", string="label")
TOKENS.STATE = Token(id="STATE", string="state")
TOKENS.STATUS = Token(id="STATUS", string="status")
TOKENS.ORIGINAL = Token(id="ORIGINAL", string="original")
TOKENS.REPLY = Token(id="REPLY", string="reply")

TOKENS.COUNTER = Token(id="COUNTER", string="counter")
TOKENS.NAME = Token(id="NAME", string="name")
TOKENS.PACKETS = Token(id="PACKETS", string="packets")
TOKENS.BYTES = Token(id="BYTES", string="bytes")
TOKENS.AVGPKT = Token(id="AVGPKT", string="avgpkt")

TOKENS.COUNTERS = Token(id="COUNTERS", string="counters")
TOKENS.QUOTAS = Token(id="QUOTAS", string="quotas")
TOKENS.LIMITS = Token(id="LIMITS", string="limits")
TOKENS.SYNPROXYS = Token(id="SYNPROXYS", string="synproxys")
TOKENS.HELPERS = Token(id="HELPERS", string="helpers")

TOKENS.LOG = Token(id="LOG", string="log")
TOKENS.PREFIX = Token(id="PREFIX", string="prefix")
TOKENS.GROUP = Token(id="GROUP", string="group")
TOKENS.SNAPLEN = Token(id="SNAPLEN", string="snaplen")
TOKENS.QUEUE_THRESHOLD = Token(id="QUEUE_THRESHOLD", string="queue-threshold")
TOKENS.LEVEL = Token(id="LEVEL", string="level")

TOKENS.LIMIT = Token(id="LIMIT", string="limit")
TOKENS.RATE = Token(id="RATE", string="rate")
TOKENS.BURST = Token(id="BURST", string="burst")
TOKENS.OVER = Token(id="OVER", string="over")
TOKENS.UNTIL = Token(id="UNTIL", string="until")

TOKENS.QUOTA = Token(id="QUOTA", string="quota")
TOKENS.USED = Token(id="USED", string="used")

TOKENS.SECMARK = Token(id="SECMARK", string="secmark")
TOKENS.SECMARKS = Token(id="SECMARKS", string="secmarks")

TOKENS.NANOSECOND = Token(id="NANOSECOND", string="nanosecond")
TOKENS.MICROSECOND = Token(id="MICROSECOND", string="microsecond")
TOKENS.MILLISECOND = Token(id="MILLISECOND", string="millisecond")
TOKENS.SECOND = Token(id="SECOND", string="second")
TOKENS.MINUTE = Token(id="MINUTE", string="minute")
TOKENS.HOUR = Token(id="HOUR", string="hour")
TOKENS.DAY = Token(id="DAY", string="day")
TOKENS.WEEK = Token(id="WEEK", string="week")

TOKENS._REJECT = Token(id="_REJECT", string="reject")
TOKENS.WITH = Token(id="WITH", string="with")
TOKENS.ICMPX = Token(id="ICMPX", string="icmpx")

TOKENS.SNAT = Token(id="SNAT", string="snat")
TOKENS.DNAT = Token(id="DNAT", string="dnat")
TOKENS.MASQUERADE = Token(id="MASQUERADE", string="masquerade")
TOKENS.REDIRECT = Token(id="REDIRECT", string="redirect")
TOKENS.RANDOM = Token(id="RANDOM", string="random")
TOKENS.FULLY_RANDOM = Token(id="FULLY_RANDOM", string="fully-random")
TOKENS.PERSISTENT = Token(id="PERSISTENT", string="persistent")

TOKENS.QUEUE = Token(id="QUEUE", string="queue")
TOKENS.QUEUENUM = Token(id="QUEUENUM", string="num")
TOKENS.BYPASS = Token(id="BYPASS", string="bypass")
TOKENS.FANOUT = Token(id="FANOUT", string="fanout")

TOKENS.DUP = Token(id="DUP", string="dup")
TOKENS.FWD = Token(id="FWD", string="fwd")

TOKENS.NUMGEN = Token(id="NUMGEN", string="numgen")
TOKENS.INC = Token(id="INC", string="inc")
TOKENS.MOD = Token(id="MOD", string="mod")
TOKENS.OFFSET = Token(id="OFFSET", string="offset")

TOKENS.JHASH = Token(id="JHASH", string="jhash")
TOKENS.SYMHASH = Token(id="SYMHASH", string="symhash")
TOKENS.SEED = Token(id="SEED", string="seed")

TOKENS.POSITION = Token(id="POSITION", string="position")
TOKENS.INDEX = Token(id="INDEX", string="index")
TOKENS.COMMENT = Token(id="COMMENT", string="comment")

TOKENS.XML = Token(id="XML", string="xml")
TOKENS.JSON = Token(id="JSON", string="json")
TOKENS.VM = Token(id="VM", string="vm")

TOKENS.NOTRACK = Token(id="NOTRACK", string="notrack")

TOKENS.EXISTS = Token(id="EXISTS", string="exists")
TOKENS.MISSING = Token(id="MISSING", string="missing")

TOKENS.EXTHDR = Token(id="EXTHDR", string="exthdr")

TOKENS.IPSEC = Token(id="IPSEC", string="ipsec")
TOKENS.MODE = Token(id="MODE", string="mode")
TOKENS.REQID = Token(id="REQID", string="reqid")
TOKENS.SPNUM = Token(id="SPNUM", string="spnum")
TOKENS.TRANSPORT = Token(id="TRANSPORT", string="transport")
TOKENS.TUNNEL = Token(id="TUNNEL", string="tunnel")

TOKENS.IN = Token(id="IN", string="in")
TOKENS.OUT = Token(id="OUT", string="out")
